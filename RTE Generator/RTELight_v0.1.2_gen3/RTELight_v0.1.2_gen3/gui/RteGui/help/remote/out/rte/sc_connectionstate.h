...
/**
*  file    SC_CONNECTIONSTATE_signal.h
*
*  brief   signal base class for signal sc_connectionstate
*
...
* name: sc_ConnectionState
* shortname: ConnectionState
*/

#ifndef SC_CONNECTIONSTATE_SIGNAL_H_INCLUDED
#define SC_CONNECTIONSTATE_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_CONNECTIONSTATE_driverIn_t)(SC_CONNECTIONSTATE_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_CONNECTIONSTATE_driverOut_t)( const SC_CONNECTIONSTATE_data_t * const);
...
/**
 * Instances of the struct SC_CONNECTIONSTATE_cfg_t represent the signal object configuration.
 */
struct SC_CONNECTIONSTATE_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_CONNECTIONSTATE_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_CONNECTIONSTATE_driverOut_t const outDriver;
...
typedef const struct SC_CONNECTIONSTATE_cfg_s SC_CONNECTIONSTATE_cfg_t;
...
/**
 * Instances of the struct SC_CONNECTIONSTATE_t represent the signal objects.
 * A signal object contains the current application value 'value' as well as relevant meta data.
 */
struct SC_CONNECTIONSTATE_s
{                                                                                                                      

	/**
	 * Data buffer for the application value
	 */
    SC_CONNECTIONSTATE_data_t value;
     ...
     */
	const SC_CONNECTIONSTATE_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_CONNECTIONSTATE_s SC_CONNECTIONSTATE_t;
 ...
 *
 * @param  SC_CONNECTIONSTATE_t * const signal: Pointer to the signal object which will be initialised
 * @param const sc_connectionstate_data_t * const value: Pointer to initial value of the application data
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONNECTIONSTATE_init( SC_CONNECTIONSTATE_t * const signal, const SC_CONNECTIONSTATE_data_t * const value )
{                                                                                                                      
 ...
 *
 * @param  SC_CONNECTIONSTATE_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_CONNECTIONSTATE_getStatus( const SC_CONNECTIONSTATE_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_CONNECTIONSTATE_setStatus( SC_CONNECTIONSTATE_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_CONNECTIONSTATE_getAge( const SC_CONNECTIONSTATE_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_CONNECTIONSTATE_incAge(  SC_CONNECTIONSTATE_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_CONNECTIONSTATE_t * const signal: Pointer to the signal object
 * @return sc_connectionstate_data_t: current value of the application data buffer
 *
 **/
inline SC_CONNECTIONSTATE_data_t RTE_SC_CONNECTIONSTATE_get( const SC_CONNECTIONSTATE_t * const signal )
{               
 ...
 *
 * @param  SC_CONNECTIONSTATE_t * const signal: Pointer to the signal object
 * @param  SC_CONNECTIONSTATE_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONNECTIONSTATE_getThreadSafe( const SC_CONNECTIONSTATE_t * const signal, SC_CONNECTIONSTATE_data_t * const data )
{    
 ...
 *
 * @param  SC_CONNECTIONSTATE_t * const signal: Pointer to the signal object
 * @param  sc_connectionstate_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONNECTIONSTATE_set(SC_CONNECTIONSTATE_t * const signal, const SC_CONNECTIONSTATE_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_CONNECTIONSTATE_pullPort( SC_CONNECTIONSTATE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_CONNECTIONSTATE_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_CONNECTIONSTATE_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_CONNECTIONSTATE_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_CONNECTIONSTATE_pushPort( const SC_CONNECTIONSTATE_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
